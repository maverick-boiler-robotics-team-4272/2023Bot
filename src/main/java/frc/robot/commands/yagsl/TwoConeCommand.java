...
public class TwoConeCommand extends SequentialCommandGroup {
    public TwoConeCommand(YagslDrive yagsldrive, ArmSubsystem arm, IntakeSubsystem intake) {
        super(
            ...
            new FollowPathWithEvents(
                new PathFollowState(yagsldrive, getGlobalTrajectories().TWO_CONE_PATH,true, true),
