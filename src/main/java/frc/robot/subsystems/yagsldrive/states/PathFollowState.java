...
public class PathFollowState extends PositionalDriveState {
    ...
    public PathFollowState(YagslDrive drivetrain, PathPlannerTrajectory trajectory, boolean resetOdometry, boolean forcePath) {
    ...
    public PathFollowState(YagslDrive drivetrain, PathPlannerTrajectory trajectory) {
