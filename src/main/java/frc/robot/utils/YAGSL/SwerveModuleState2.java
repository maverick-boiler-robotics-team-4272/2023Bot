...
//      return desiredState;
    ...
    {
      double lowerBound = currentAngle.getDegrees() - MathUtils.euclideanModulo(currentAngle.getDegrees(), 360);
      double upperBound = 360 + lowerBound;

      double targetAngle = MathUtils.inputModulo(desiredState.angle.getDegrees(), lowerBound, upperBound);
